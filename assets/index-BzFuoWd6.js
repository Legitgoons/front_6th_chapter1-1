...
`;var m=p;const h=({products:e,total:t,search:n=``,sort:r=`price_asc`,loadingMore:i=!1,hasMore:a=!0})=>`
  ...
  `;var g=h;const ee=(e=20,t=``,n=`price_asc`)=>`
  <main class="max-w-md mx-auto px-4 py-4">
  <!-- 검색 및 필터 -->
  ${u(e,t,n)}
    <!-- 상품 목록 -->
...
`;var _=ee;const v=(e,t)=>{let n=document.getElementById(`list-page-container`);if(n){let r=t.getHasMore(),i=t.getLoadingMore();n.innerHTML=e.loading?_(e.limit,e.search,e.sort):g({products:e.products,total:e.total,search:e.search,sort:e.sort,loadingMore:i,hasMore:r}),e.loading||(b(t),y(t))}},y=e=>{let t=document.body.getAttribute(`data-scroll-listener`);if(t)return;document.body.setAttribute(`data-scroll-listener`,`true`);let n=()=>{let t=window.pageYOffset||document.documentElement.scrollTop,n=window.innerHeight,r=document.documentElement.scrollHeight;t+n>=r-100&&e.getHasMore()&&!e.getLoadingMore()&&e.loadMoreData(t=>{v(t,e)})};window.addEventListener(`scroll`,n);let r=history.pushState;history.pushState=function(){document.body.removeAttribute(`data-scroll-listener`),window.removeEventListener(`scroll`,n),r.apply(history,arguments)}},b=e=>{let t=document.querySelector(`#limit-select`),n=document.querySelector(`#search-input`),r=document.querySelector(`#sort-select`);t&&(t.value=e.getLimit().toString(),t.addEventListener(`change`,t=>{let n=t.target,r=parseInt(n.value,10);isNaN(r)||e.setLimit(r,t=>{v(t,e)})})),n&&(n.value=e.getSearch(),n.addEventListener(`keydown`,t=>{if(t.key===`Enter`){t.preventDefault();let r=n.value;e.setSearch(r,t=>{v(t,e)})}})),r&&(r.value=e.getSort(),r.addEventListener(`change`,t=>{let n=t.target,r=n.value;e.setSort(r,t=>{v(t,e)})}))},x=()=>`
    <div id="list-page-container" class="min-h-screen">
      <!-- 로딩 상태가 여기에 표시됩니다 -->
    </div>
  `;async function S(e={}){let{limit:t=20,search:n=``,category1:r=``,category2:i=``,sort:a=`price_asc`}=e,o=e.current??e.page??1,s=new URLSearchParams({page:o.toString(),limit:t.toString(),...n&&{search:n},...r&&{category1:r},...i&&{category2:i},sort:a}),c=await fetch(`/api/products?${s}`);return await c.json()}async function C(e){let t=await fetch(`/api/products/${e}`);return await t.json()}const w=`listPageFilters`;var T=class{constructor(){this.state={products:[],total:0,loading:!1},this.limit=20,this.search=``,this.sort=`price_asc`,this.currentPage=1,this.hasMore=!0,this.loadingMore=!1,this.loadFromLocalStorage()}loadFromLocalStorage(){try{let e=localStorage.getItem(w);if(e){let t=JSON.parse(e);typeof t.limit==`number`&&t.limit>0&&(this.limit=t.limit),typeof t.search==`string`&&(this.search=t.search),typeof t.sort==`string`&&t.sort&&(this.sort=t.sort)}}catch(e){console.warn(`Failed to load filter state from localStorage:`,e)}}saveToLocalStorage(){try{let e={limit:this.limit,search:this.search,sort:this.sort};localStorage.setItem(w,JSON.stringify(e))}catch(e){console.warn(`Failed to save filter state to localStorage:`,e)}}async loadData(e){this.state.loading=!0,this.currentPage=1,this.hasMore=!0,this.loadingMore=!1,e({...this.state,limit:this.limit,search:this.search,sort:this.sort});let t=await S({limit:this.limit,search:this.search,sort:this.sort,page:this.currentPage});this.state.products=t.products,this.state.total=t.pagination.total,this.hasMore=t.pagination.hasNext,this.state.loading=!1,e({...this.state,limit:this.limit,search:this.search,sort:this.sort})}async loadMoreData(e){if(!(this.loadingMore||!this.hasMore)){this.loadingMore=!0,this.currentPage+=1,e({...this.state,limit:this.limit,search:this.search,sort:this.sort,loadingMore:!0});try{let t=await S({limit:this.limit,search:this.search,sort:this.sort,page:this.currentPage});this.state.products=[...this.state.products,...t.products],this.state.total=t.pagination.total,this.hasMore=t.pagination.hasNext,this.loadingMore=!1,e({...this.state,limit:this.limit,search:this.search,sort:this.sort,loadingMore:!1})}catch(t){console.error(`Failed to load more data:`,t),this.loadingMore=!1,--this.currentPage,e({...this.state,limit:this.limit,search:this.search,sort:this.sort,loadingMore:!1})}}}async setLimit(e,t){this.limit!==e&&(this.limit=e,this.saveToLocalStorage(),await this.loadData(t))}async setSearch(e,t){let n=e.trim();this.search!==n&&(this.search=n,this.saveToLocalStorage(),await this.loadData(t))}async setSort(e,t){this.sort!==e&&(this.sort=e,this.saveToLocalStorage(),await this.loadData(t))}getLimit(){return this.limit}getSearch(){return this.search}getSort(){return this.sort}getHasMore(){return this.hasMore}getLoadingMore(){return this.loadingMore}};const E=`
  <main class="max-w-md mx-auto px-4 py-4">
...
`;var D=E;const O=e=>`
  ...
  `;var F=P,I=F;const L=I;var R=L,z=class{constructor(){this.state={product:null,relatedProducts:[],loading:!1}}async loadProductData(e,t){this.state.loading=!0,t({...this.state});try{let n=await C(e);if(this.state.product=n,n&&n.category2){let t=await S({limit:10,category2:n.category2});this.state.relatedProducts=t.products.filter(t=>t.productId!==e).slice(0,20)}this.state.loading=!1,t({...this.state})}catch(e){console.error(`Failed to load product data:`,e),this.state.loading=!1,this.state.product=null,this.state.relatedProducts=[],t({...this.state})}}getState(){return{...this.state}}};const B=`
<main class="max-w-md mx-auto px-4 py-4">
...
`;var te=B;const V=`/front_6th_chapter1-1`,H=(e=window.location.pathname)=>e.startsWith(V)?e.slice(21)||`/`:e,U=e=>V+e;var W=class{constructor(){this.routes={},this.currentRoute=null,this.initialized=!1,window.addEventListener(`popstate`,()=>{let e=H(window.location.pathname);this.navigate(e,!1)})}init(){if(!this.initialized){this.initialized=!0;let e=H(window.location.pathname);this.navigate(e,!1)}}addRoute(e,t){this.routes[e]=t}navigate(e,t=!0){if(t){let t=U(e);window.history.pushState({},``,t)}this.currentRoute=e;let n=this.findRoute(e);if(n)n.handler(n.params);else{let e=this.routes[`*`];e&&e()}}findRoute(e){if(this.routes[e])return{handler:this.routes[e],params:{}};for(let t in this.routes)if(t.includes(`:`)){let n=this.matchRoute(t,e);if(n)return{handler:this.routes[t],params:n}}return null}matchRoute(e,t){let n=e.split(`/`),r=t.split(`/`);if(n.length!==r.length)return null;let i={};for(let e=0;e<n.length;e++){let t=n[e],a=r[e];if(t.startsWith(`:`)){let e=t.slice(1);i[e]=a}else if(t!==a)return null}return i}getCurrentRoute(){return this.currentRoute}};const G=new W;var K=class{constructor(){this.state={items:[],totalCount:0,totalPrice:0},this.subscribers=[]}subscribe(e){return this.subscribers.push(e),e(this.state),()=>{this.subscribers=this.subscribers.filter(t=>t!==e)}}notify(){this.subscribers.forEach(e=>e(this.state))}addItem(e){let t=this.state.items.findIndex(t=>t.productId===e.productId);return t>=0?!1:(this.state.items.push({...e}),this.updateTotals(),this.notify(),!0)}removeItem(e){this.state.items=this.state.items.filter(t=>t.productId!==e),this.updateTotals(),this.notify()}updateItemQuantity(e,t){let n=this.state.items.findIndex(t=>t.productId===e);n>=0&&(t<=0?this.removeItem(e):(this.state.items[n].quantity=t,this.updateTotals(),this.notify()))}clearCart(){this.state.items=[],this.updateTotals(),this.notify()}updateTotals(){this.state.totalCount=this.state.items.reduce((e,t)=>e+t.quantity,0),this.state.totalPrice=this.state.items.reduce((e,t)=>e+t.price*t.quantity,0)}getCartCount(){return this.state.totalCount}getState(){return{...this.state}}hasItem(e){return this.state.items.some(t=>t.productId===e)}getItemQuantity(e){let t=this.state.items.find(t=>t.productId===e);return t?t.quantity:0}};const q=new K,J=()=>r(async()=>{let{worker:e,workerOptions:t}=await import(`./browser-DvH8zzVn.js`);return{worker:e,workerOptions:t}},[]).then(({worker:e,workerOptions:t})=>e.start(t));J().then($);let Y=null,X=null;function Z(e,t=!1){let n=q.getCartCount();document.body.querySelector(`#root`).innerHTML=`
  ...
  `}function Q(){Z(x()),Y||=new T,Y.loadData(e=>{v(e,Y)})}function ne(e){let t=e.productId;Z(R({loading:!0}),!0),X=new z,X.loadProductData(t,e=>{let t=R({product:e.product,relatedProducts:e.relatedProducts,loading:e.loading}),n=document.getElementById(`page-content`);n&&(n.innerHTML=t),ae()})}function re(){Z(te)}function ie(){document.addEventListener(`click`,e=>{let t=e.target;if(t&&t.classList.contains(`add-to-cart-btn`)){e.preventDefault();let n=t.closest(`.product-card`);if(n){let e=n.getAttribute(`data-product-id`)||t.getAttribute(`data-product-id`),r=n.querySelector(`h3`)?.textContent||n.querySelector(`h1`)?.textContent||``,i=n.querySelector(`img`)?.src||``,a=n.querySelector(`.text-lg, .text-2xl`)?.textContent||`0`,o=parseInt(a.replace(/[^0-9]/g,``))||0,s=document.querySelector(`#quantity-input`),c=s&&parseInt(s.value)||1;e&&r&&o>0&&q.addItem({productId:e,title:r,image:i,price:o,quantity:c})}}})}function ae(){let e=document.querySelector(`.go-to-product-list`);e&&e.addEventListener(`click`,e=>{e.preventDefault(),G.navigate(`/`)});let t=document.querySelectorAll(`.breadcrumb-link`);t.forEach(e=>{e.addEventListener(`click`,e=>{e.preventDefault(),G.navigate(`/`)})});let n=document.querySelectorAll(`.related-product-card`);n.forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault();let n=e.dataset.productId;n&&G.navigate(`/product/${n}`)})});let r=document.getElementById(`quantity-decrease`),i=document.getElementById(`quantity-increase`),a=document.getElementById(`quantity-input`);r&&i&&a&&(r.addEventListener(`click`,()=>{let e=parseInt(a.value);e>1&&(a.value=e-1)}),i.addEventListener(`click`,()=>{let e=parseInt(a.value),t=parseInt(a.max);e<t&&(a.value=e+1)}))}async function $(){G.addRoute(`/`,Q),G.addRoute(`/product/:productId`,ne),G.addRoute(`*`,re),G.init(),q.subscribe(e=>{let t=document.querySelector(`header`);if(t){let n=G.getCurrentRoute().startsWith(`/product/`);t.outerHTML=s({cartCount:e.totalCount,isDetail:n})}}),ie(),document.addEventListener(`click`,e=>{if(e.target.closest(`[data-link]`)){e.preventDefault();let t=e.target.closest(`[data-link]`),n=t.getAttribute(`href`)||`/`;G.navigate(n)}let t=e.target.closest(`.product-card`);if(t&&(e.target.closest(`.product-image`)||e.target.closest(`.product-info`))){e.preventDefault();let n=t.dataset.productId;n&&G.navigate(`/product/${n}`)}})}J().then($);